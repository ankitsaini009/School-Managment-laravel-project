...
<div class="card">
  <div class="card-body">
    <h3 class="card-title">Monthly Attendances Report</h3><br>
    <form action="{{route('monthlyreport')}}" method="get" class="forms-sample">
      ...
      <div class="row">
        ...
        <div class="col-2">
        <button type="submit" style="margin-top: 24px;" class="btn btn-primary mr-2 mb-3">Search</button>
      </div>
      </div>
