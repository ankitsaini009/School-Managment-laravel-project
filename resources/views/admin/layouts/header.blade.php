...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha384-7pa8RmAxTpL2IziydEBu8JLeAaNlRFyic0qnXloaG8E+9aI3dceuvH86Ig9G1g3O" crossorigin="anonymous">
    ...
    @yield('head')
    <link rel="stylesheet" href="{{ asset('pickr/dist/themes/classic.min.css') }}">
    <script src="{{ asset('pickr/dist/pickr.min.js') }}"></script>
    <link href="{{ asset('/summernote/dist/summernote.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-x0lI9/KLXM84YBstQeNlGh+KCy9BD2kM+2AJl7+R+Jf4+h4UW/onUO7JBZ1l+TXCuC5M5jE65phsw6t0bTaAgQ==" crossorigin="anonymous" />
    ...
    <div class="container-scroller">
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="{{ route('admin.dashboard') }}"><img src="{{ asset($sitedata->site_logo)}}" class="mr-2" alt="logo"></a>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                            <img src="{{ asset('/') }}images/download.png" alt="profile">
                        </a>
