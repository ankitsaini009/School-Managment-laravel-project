                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" name="name_x_position"
                                ...
                                value="490" placeholder="Name X-axis Position">
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" name="name_y_position"
                                ...
                                value="760" placeholder="Name Y-axis Position">
                        </div>
                        <div class="form-group col-md-4">
                            <label>Set Name Font Size<span class="mandatory-symbol">*</span></label>
                            <input type="number" name="name_fontsize"
                                class="form-control {{ $errors->has('name_fontsize') ? 'is-invalid' : '' }}" value="150"
                                placeholder="Name Y-axis Position">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-12">
                            <label>Certificate Discription<span class="mandatory-symbol">*</span></label>
                            <textarea name="student_discription" id="student_discription" class="form-control" rows="4"></textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" name="discrip_x_position"
                                ...
                                value="300" placeholder="Discription X-axis Position">
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" name="discrip_y_position"
                                ...
                                value="840" placeholder="Discription Y-axis Position">
                        </div>
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" name="discription_fontsize"
                                ...
                                value="60" placeholder="Discription Y-axis Position">
                        </div>
                        <div class="form-group col-md-3">
                            <label>Give Line Length Break From<span class="mandatory-symbol">*</span></label>
                            <input type="number" name="line_length"
                                class="form-control {{ $errors->has('line_length') ? 'is-invalid' : '' }}" value="90"
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="release_date" id="release_date"
                                class="form-control {{ $errors->has('release_date') ? 'is-invalid' : '' }}" value=""
                        ...
                        <div class="form-group col-md-3 col-sm-12">
                            ...
                            <input type="hidden" name="name_color" id="colorInput" value="" class="">
                            @error('name_color')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    @section('scripts')
                        <script>
                            ...
                            $(document).ready(function() {
                                ...
                                $('#release_date').datepicker('setDate', formattedDate);

                                // Ensure the format is still applied
                                $('#release_date').datepicker('update');
                            });
