...
<div class="card">
    <div class="card-body">
      <div class="d-flex justify-content-between">
          ...
          <p class="card-title"><a href="{{route('certificate.add.form')}}" class="btn btn-success">Add Certificate</a></p>
      </div>
      <div class="row">
        <div class="col-12">
                  ...
                  <table class="display expandable-table data-table no-footer" style="width: 100%;"
                    ...
                    <thead>
                      <tr role="row">
                        ...
                        <th class="sorting_asc" style="width: 51px;">Certificate Template</th>
