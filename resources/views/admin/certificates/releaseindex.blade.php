...
<div class="card">
    <div class="card-body">
      <div class="d-flex justify-content-between">
          ...
          <p class="card-title"><a href="{{route('release.form')}}" class="btn btn-success">Release Certificate</a></p>
      </div>
      <div class="row">
        <div class="col-12">
                  ...
                  <table class="display expandable-table data-table no-footer" style="width: 100%;"
                    ...
                    <thead>
                      <tr role="row">
                        ...
                        <th class="sorting_asc" style="width: 51px;">Certificate Name</th>
                        <th class="sorting_asc" style="width: 51px;">Holder Name</th>
                        <th class="sorting_asc" style="width: 51px;">Certificate Image</th>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.0/jquery.validate.js"></script>
    ...
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('released.certificates.index') }}",
        columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex'},
            {data: 'certificate_name', name: 'certificate_name'},
