    ...
    <div class="col-12 grid-margin stretch-card">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('add.certificate') }}" method="POST" enctype="multipart/form-data" class="forms-sample">
                    @csrf
                    <div class="row">
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="exampleInputName1">Certificate Name<span class="mandatory-symbol">*</span></label>
                            <input type="text" Name="Certificate_Name"
                                class="form-control {{ $errors->has('Certificate_Name') ? 'is-invalid' : '' }}"
                                id="exampleInputName1" placeholder="Name" value="{{ old('Certificate_Name') }}">
                            @error('Certificate_Name')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="exampleInputName1">Certificate Status<span class="mandatory-symbol">*</span></label>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 col-sm-12">
                            <label>Certificate Tamplate<span class="mandatory-symbol">*</span></label>
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            <label>Name Font<span class="mandatory-symbol">*</span></label>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <div>
                                <p><span class="mandatory-symbol">Note:</span>In The Discription Use
                                    '[HOLDER_NAME]','[HOLDER_PARENT]','[HOLDER_CLASS]','[HOLDER_SCHOLL]' For Custome Details
                                </p>
                            </div>
                            <label for="exampleInputName1">Certificate Discription<span
                                    class="mandatory-symbol">*</span></label>
                            <textarea name="Certificate_Discription"
                                class="form-control {{ $errors->has('Certificate_Discription') ? 'is-invalid' : '' }}" id=""
                                rows="5"></textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="exampleInputName1">Discription Text Color<span
                                    class="mandatory-symbol">*</span></label>
                            <input type="hidden" name="Discription_Color" value="" id="colorInput"
                                class="form-control {{ $errors->has('Discription_Color') ? 'is-invalid' : '' }}">
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            <label>Discription Font<span class="mandatory-symbol">*</span></label>
                            <input type="file" Name="Discription_Font" id="font_file" class="file-upload-default">
                            <div class="input-group col-xs-12">
                                <input type="text"
                                    class="form-control file-upload-info {{ $errors->has('Discription_Font') ? 'is-invalid' : '' }}"
                                    disabled="" placeholder="Upload Image">
                                <span class="input-group-append">
                                    <button class="file-upload-browse btn btn-primary" type="button">Choose</button>
                                </span>
                            </div>
                            @error('Discription_Font')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
                    ...
                    $('#font_file').change(function() {
                        ...
                        if (file) {
                            ...
                            if (fileExt === 'ttf' || fileExt === 'woff') {
                                ...
                                alert('Please select a TTF or a woff file.');
                                $(this).val('');
                            }
                        }
                    });
